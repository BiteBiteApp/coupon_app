...
class _BiteScoreDishDetailScreenState extends State<BiteScoreDishDetailScreen> {
  ...
  Widget _buildMiniMetric(String label, double? value) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
      decoration: BiteRaterTheme.chipDecoration(BiteRaterTheme.ocean),
      child: Text(
        value == null ? '$label Not rated' : '$label ${value.toStringAsFixed(1)}',
        style: const TextStyle(
          color: BiteRaterTheme.ink,
          fontSize: 12,
          fontWeight: FontWeight.w700,
  ...
  Future<void> _reportReview(DishReview review) async {
    ...
    try {
      ...
      _showSnackBar(submitted ? 'Review reported.' : 'You already reported this review.');
      setState(_refresh);
    } catch (error) {
      _showSnackBar(
        AppErrorText.friendly(
  ...
  Future<void> _reportDish() async {
    ...
    try {
      ...
      _showSnackBar(
        submitted ? 'Dish reported for admin review.' : 'You already reported this dish.',
      );
    } catch (error) {
      _showSnackBar(
        AppErrorText.friendly(
  ...
  Widget _buildReviewCard(
    ...
    final publicDisplayName =
        (reviewerDisplayName ?? '').trim().isEmpty
            ? 'Reviewer'
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration:
                            BiteRaterTheme.chipDecoration(BiteRaterTheme.coral),
                        child: Text(
                          review.overallBiteScore.toStringAsFixed(0),
                          style: const TextStyle(
                            color: BiteRaterTheme.scoreFlame,
                            fontWeight: FontWeight.w900,
                          ),
            ...
            if (notes.isNotEmpty) ...[
              SizedBox(height: headline.isNotEmpty ? 8 : 0),
              Text(notes),
            ],
            ...
            Wrap(
              ...
              children: [
                ...
                if (trustSummary.helpfulCount > 0)
                  Container(
                    padding: const EdgeInsets.symmetric(
                      horizontal: 10,
                      vertical: 6,
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(999),
                      border: Border.all(
                        color: BiteRaterTheme.mint.withOpacity(0.16),
                      ),
                    ),
                    child: Text(
                      'Helpful to ${trustSummary.helpfulCount}',
                      style: const TextStyle(
  ...
  Widget _buildReviewerBadgeChip(String badgeLabel) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: badgeStyle.$1.withOpacity(0.08),
        borderRadius: BorderRadius.circular(999),
        border: Border.all(
          color: badgeStyle.$1.withOpacity(0.16),
        ),
      ),
      child: Row(
        ...
        children: [
          Icon(
            badgeStyle.$2,
            size: 12,
            color: badgeStyle.$1.withOpacity(0.90),
          ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 6),
            Text(
              _canSuggestDishEdits
                  ? 'Suggest a rename or merge if this dish listing should be cleaned up.'
                  : 'Sign in to suggest a rename or merge for this dish.',
              style: const TextStyle(
                color: BiteRaterTheme.mutedInk,
                fontWeight: FontWeight.w600,
              ),
    ...
    return Scaffold(
      ...
      body: FutureBuilder<_DishDetailData>(
        ...
        builder: (context, snapshot) {
          ...
          final visibleReviews = detail.reviews.take(_visibleReviewCount).toList();
            ...
            children: [
              ...
              Expanded(
                ...
                BiteRaterTheme.liftedCard(
                  radius: 24,
                  borderColor: BiteRaterTheme.peach.withOpacity(0.22),
                  child: Padding(
                      ...
                      children: [
                        ...
                        Center(
                          child: Column(
                            children: [
                              Text(
                                detail.aggregate.overallBiteScore > 0
...
class _DishManagementDialogState extends State<_DishManagementDialog> {
  ...
  void initState() {
    ...
    _priceController =
        TextEditingController(text: widget.dish.priceLabel ?? '');
...
class _DishRenameSuggestionDialog extends StatefulWidget {
  ...
  const _DishRenameSuggestionDialog({
    required this.dish,
  });
...
class _DishMergeSuggestionDialogState extends State<_DishMergeSuggestionDialog> {
