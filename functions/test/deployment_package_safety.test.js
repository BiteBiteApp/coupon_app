...
test("required source, package, compiled, validator, and test artifacts are not excluded", () => {
  const requiredPaths = [
    ...
    "lib/rating_destructive_callable_contract.js",
    "lib/rating_destructive_callable_handlers.js",
    "lib/rating_destructive_scheduler.js",
    "lib/rating_destructive_status_paging.js",
    ...
    "src/rating_destructive_callable_contract.ts",
    "src/rating_destructive_callable_handlers.ts",
    "src/rating_destructive_scheduler.ts",
    "src/rating_destructive_status_paging.ts",
    ...
    "test/rating_destructive_callable_handlers.test.js",
    "test/rating_destructive_scheduler.test.js",
    "test/rating_destructive_status_paging.test.js",
