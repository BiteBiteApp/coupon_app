...
Map<String, Object?> _offer(String id) => <String, Object?>{
  'offerId': id,
...
Map<String, Object?> _entry({
  ...
  'offer': available && offerId != null ? _offer(offerId) : null,
  'accessToken': available ? 'bssv1.test-token-$restaurantId-$offerId' : null,
};
